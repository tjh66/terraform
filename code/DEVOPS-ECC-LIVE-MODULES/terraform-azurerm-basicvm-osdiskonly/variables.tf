...
variable "ecc_vm_as_name"{
type = string
description = "Name of existing Availability Set"
}
...
variable "ecc_vm_as_rg"{ #may not need this
type = string
description = "ResourceGroup of existing Availability Set"
}
